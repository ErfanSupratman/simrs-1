...
<script type="text/javascript">
	$(document).ready(function (e) {
		...
		$('#tblinventorigudangbarang').DataTable();
		$('#tabelriwayatpenerimaanbarang').DataTable();
		$('#tabelpersetujuanpermintaan').DataTable();
		$('#tabelriwayatpersetujuan').DataTable();
		$('#tabelbarangutama').DataTable();
		$('#tabelriwayatpengadaan').DataTable();
