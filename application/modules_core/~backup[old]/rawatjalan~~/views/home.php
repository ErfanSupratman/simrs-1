									...
									echo '<tr>';
										echo '<td>'.$i.'</td>';
							 			...
							 			echo'<td style="text-align:center">';
							 				echo'<a href="'.base_url().'rawatjalan/daftarpasien/periksa/'.$data['rm_id'].'/'.$data['visit_id'].'" onclick="visit(&quot;'.$data['rm_id'].'&quot; , &quot;'.$data['visit_id'].'&quot;)"><i class="fa fa-plus" data-toggle="tooltip" data-placement="top" title="Pemeriksaan"></i></a>';
										echo'</td>';
							 		echo'</tr>';
								}
							?>
