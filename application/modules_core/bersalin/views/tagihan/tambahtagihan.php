...
<div class="bar">
	<li style="list-style: none">
		...
		<i class="fa fa-angle-right"></i>
		<a href="<?php echo base_url() ?>bersalun/tambahtagihan">Tambah Invoice</a>
	</li>
</div>
       	...
       	<div class="informasi">
         	<form class="form-horizontal" role="form">
       				...
       				<tr>
       					...
       					<td width="50%">
							...
							<div class="form-group" id="kelas">
								<label class="control-label col-md-5">Kelas Pelayanan </label>
       			...
       			<div class="pull-right" style="margin-right:20px">
	  			 	...
	  			 	<a href="<?php echo base_url() ?>bersalin/tagihannonbpjs" class="btn btn-success" id="ivnonbpjs">Tambah Tagihan</a>
	  			 	<a href="<?php echo base_url() ?>bersalin/tagihanbpjs" class="btn btn-success" id="ivbpjs">Tambah Tagihan</a>
	  			 </div>
       		</form>
       		<br><br><br>
       	</div>
