...
<div class="navigation" style="margin-left: 10px" >
 	<ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
	    ...
	    <li><a href="#ibu"  data-toggle="tab">Catatan Kesehatan Ibu Hamil</a></li>
	        ...
	        <div class="informasi" id="infoKamar">
	            <form class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-md-3">			
							<select class="form-control select" name="order" id="order" disabled>
            ...
            <div class="informasi" id="infoBersalin">
            	<form class="form-horizontal" role="form">
					...
					<div class="form-group" id="asalRujukan">
						<label class="control-label col-md-3" >Asal Rujukan
						</label>
						<div class="col-md-2">			
        ...
        <div class="tab-pane" id="daftar">
            ...
            <div class="informasi" id="infoKelahiran">
            	<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						<div class="form-inline">
							<label class="control-label col-md-3" >Status Fisik
							</label>
							<div class="col-md-7">		
								<form role="form">
									<label class="checkbox-inline"><input type="checkbox" value="Anus">Anus Hilang</label>
									<label class="checkbox-inline"><input type="checkbox" value="Cacat">Cacat Fisik</label>
								</form>
							</div>							
						</div>
					</div>
