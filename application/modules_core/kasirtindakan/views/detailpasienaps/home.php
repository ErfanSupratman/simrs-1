...
<div class="title">
	PROSES KASIR TINDAKAN PASIEN APS
</div>
<div class="bar">
		<li style="list-style: none">
			...
			<i class="fa fa-angle-right"></i>
			<a href="<?php echo base_url() ?>kasirtindakan/detailpasienaps">Proses Kasir Tindakan Pasien APS</a>
...
<div class="navigation" style="background: #A7FFAE; min-height:800px;border-radius:5px; margin-left: 10px;margin-right: 10px;" >
        ...
        <div id="titleInformasi">Informasi Pasien APS</div>
	    </div>
	    <br>
    	...
    	<div class="informasi" id="infoDataPasienObat" style="margin-left:50px;">
        	<form class="form-horizontal" role="form">
        		<div class="form-group">
        			...
        			<label class="col-md-3" id="nmrNotaKasirAPS" name="nmrNotaKasirAPS" style="font-weight:bold">
        			12121212	
        			</label>
        			<div class="col-md-1"></div>
        			<label class="control-label col-md-2">Cara Bayar</label>
        			<label class="col-md-3" id="crBayarNotaKasirAPS" name="crBayarNotaKasirAPS" style="font-weight:bold">
        			Nyicil
        			</label>
        		</div>
        		<div class="form-group">
        			<label class="control-label col-md-2">Tanggal</label>
        			<label class="col-md-3" id="tglNotaKasirAPS" name="tglNotaKasirAPS" data-provide="datepicker" style="font-weight:bold">
        			21 Juli 2015
        			</label>
        			<div class="col-md-1"></div>
        			<label class="control-label col-md-2">Nama Asuransi</label>
        			<label class="col-md-3" id="nmAsuransiNotaKasirAPS" name="nmAsuransiNotaKasirAPS" style="font-weight:bold">
        			Prudential
        			</label>
        		</div>
        		<div class="form-group">
        			<label class="control-label col-md-2">No RM</label>
        			<label class="col-md-3" id="nmrRMNotaKasirAPS" name="nmrRMNotaKasirAPS" style="font-weight:bold">
					12010210	
					</label>
        			<div class="col-md-1"></div>
        			<label class="control-label col-md-2">No Asuransi</label>
        			<label class="col-md-3" id="noAsuNotaKasirAPS" name="noAsuNotaKasirAPS" style="font-weight:bold">
        			99912012
        			</label>
        		</div>
        		<div class="form-group">
        			<label class="control-label col-md-2">Nama Pasien</label>
        			<label class="col-md-3" id="nmPasienNotaKasirAPS" name="nmPasienNotaKasirAPS" style="font-weight:bold">
        			Irma
        			</label>
        			<div class="col-md-1"></div>
        			<label class="control-label col-md-2">Nama Perusahaan</label>
        			<label class="col-md-3" style="font-weight:bold" id="nmPrusahaanNotaKasirAPS" name="nmPrusahaanNotaKasirAPS">
        			IBM
        			</label>
        		</div>
        		<div class="form-group">
        			<label class="control-label col-md-2">Alamat Pasien</label>
        			<label class="col-md-3" style="font-weight:bold" id="almPasienNotaKasirAPS" name="almPasienNotaKasirAPS">
        			Jalan Bali
        			</label>
        			<div class="col-md-1"></div>
        			<label class="control-label col-md-2">Deposit</label>
        			<label class="col-md-3" style="font-weight:bold" id="depoNotaKasirAPS" name="depoNotaKasirAPS">
        			Depo
        			</label>
        		</div>
        		<div class="form-group">
        			<label class="control-label col-md-2">Kelas Perawatan</label>
        			<label class="col-md-3" style="font-weight:bold" id="klsPasienNotaKasirAPS" name="klsPasienNotaKasirAPS" >
        			VIP
        			</label>
			...
			<div class="portlet-body" style="margin: 0px 30px 0px 0px">
				...
				<div class="form-group">
					<div class="col-md-2 pull-right" style="width:140px;">
						<input type="text" class="form-control" id="potonganAPS" name="potonganAPS" placeholder="Potongan" />
					</div>
					<div class="col-md-2 pull-right" style="width:100px;">
	         			<select class="form-control select" name="jenispotonganAPS" id="selectpotonganAPS" >
				...
				<div class="form-group">
					<div class="col-md-2 pull-right" style="width:240px;">
						<input type="text" class="form-control" id="depositKasirAPS" name="depositKasirAPS" placeholder="Deposit" />
					</div>
					<div class="col-md-2 pull-right" style="width:150px; margin-top:5px; text-align:right;">
						Deposit (Rp.) : 
					</div>
...
<script type="text/javascript">
	$(document).ready( function(){
			$('.addNewTindakan').on('click',function(e){
				e.preventDefault();
				tambahTabelKasir('#addinputTindakanAPS','.addNewTindakan');
			});
	});
