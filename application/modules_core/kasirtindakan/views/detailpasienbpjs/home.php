...
<div class="title">
	PROSES KASIR TINDAKAN PASIEN BPJS
</div>
<div class="bar">
		<li style="list-style: none">
			...
			<i class="fa fa-angle-right"></i>
			<a href="<?php echo base_url() ?>kasirtindakan/detailpasienbpjs">Proses Kasir Tindakan Pasien BPJS</a>
    	...
    	<div class="informasi" id="infoDataPasienObat" style="margin-left:50px;">
        	<form class="form-horizontal" role="form">
        		<div class="form-group">
        			...
        			<label class="col-md-3" id="nmrNotaKasirbpjs" name="nmrNotaKasirbpjs" style="font-weight:bold">
        			12121212	
        			</label>
        			<div class="col-md-1"></div>
        			<label class="control-label col-md-2">Cara Bayar</label>
        			<label class="col-md-3" id="crBayarNotaKasirbpjs" name="crBayarNotaKasirbpjs" style="font-weight:bold">
        			Nyicil
        			</label>
        		</div>
        		<div class="form-group">
        			<label class="control-label col-md-2">Tanggal</label>
        			<label class="col-md-3" id="tglNotaKasirbpjs" name="tglNotaKasirbpjs" data-provide="datepicker" style="font-weight:bold">
        			21 Juli 2015
        			</label>
        			<div class="col-md-1"></div>
        			<label class="control-label col-md-2">No BPJS</label>
        			<label class="col-md-3" id="noBPJSNotaKasir" name="noBPJSNotaKasir" style="font-weight:bold">
        			332323
        			</label>
        		</div>
        		<div class="form-group">
        			<label class="control-label col-md-2">No RM</label>
        			<label class="col-md-3" id="nmrRMNotaKasirbpjs" name="nmrRMNotaKasirbpjs" style="font-weight:bold">
					12010210	
					</label>
        			<div class="col-md-1"></div>
        			<label class="control-label col-md-2">Kelas Pelayanan BPJS</label>
        			<label class="col-md-3" id="klsBPJSKasir" name="klsBPJSKasir" style="font-weight:bold">
        			VIP
        			</label>
        		</div>
        		<div class="form-group">
        			<label class="control-label col-md-2">Nama Pasien</label>
        			<label class="col-md-3" id="nmPasienNotaKasirBPJS" name="nmPasienNotaKasirBPJS" style="font-weight:bold">
        			Irma
        			</label>
        			<div class="col-md-1"></div>
        			<label class="control-label col-md-2">Kelas Perawatan</label>
        			<label class="col-md-3" style="font-weight:bold" id="klsPasienNotaKasirbpjs" name="klsPasienNotaKasirbpjs" >
        			VIP
        			</label>
        		...
        		<div class="form-group">
        			...
        			<label class="col-md-3" style="font-weight:bold" id="almPasienNotaKasirbpjs" name="almPasienNotaKasirbpjs">
        			Jalan Bali
        			</label>
        			<div class="col-md-1"></div>
        			<label class="control-label col-md-2">Deposit</label>
        			<label class="col-md-3" style="font-weight:bold" id="depoNotaKasirbpjs" name="depoNotaKasirbpjs">
        			Depo
        			</label>
        		</div>
        	</form>
			...
			<div class="portlet-body" style="margin: 0px 30px 0px 0px">
				...
				<table class="table table-striped table-bordered table-hover table-responsive" >
					<thead>
						<tr class="info" >
							...
							<th  style="text-align:left"> Tarif BPJS</th>
				...
				<div class="form-group">
					<div class="col-md-2 pull-right" style="width:140px;">
						<input type="text" class="form-control" id="potonganbpjs" name="potonganbpjs" placeholder="Potongan" />
					</div>
					<div class="col-md-2 pull-right" style="width:100px;">
	         			<select class="form-control select" name="jenispotonganbpjs" id="selectpotonganbpjs" >
				...
				<div class="form-group">
					<div class="col-md-2 pull-right" style="width:240px;">
						<input type="text" class="form-control" id="depositKasirbpjs" name="depositKasirbpjs" placeholder="Deposit" />
					</div>
					<div class="col-md-2 pull-right" style="width:150px; margin-top:5px; text-align:right;">
						Deposit (Rp.) : 
					</div>
...
<script type="text/javascript">
	$(document).ready( function(){
			$('.addNewTindakan').on('click',function(e){
				e.preventDefault();
				tambahTabelKasirBPJS('#addinputTindakanBPJS','.addNewTindakan');
			});
	});
