<script type="text/javascript">
	$(document).ready(function (argument) {
		...
		$('#formsearchobatretur').submit(function (e) {
			...
			$.ajax({
				type: "POST",
				data: item,
				url: '<?php echo base_url()?>icu/homeicu/get_obat_retur',
				success: function (data) {
					//console.log(data);
		...
		$('#forminoutbarang').submit(function (e) {
		    ...
		    if (item['jumlah'] != "") {
			    $.ajax({
			    	type: "POST",
			    	data: item,
			    	url: "<?php echo base_url()?>icu/homeicu/input_in_outbarang",
			    	success: function (data) {
			    		if (data == "true") {
			    			alert('data berhasil disimpan');
			    			$('#inoutbar').modal('hide');	
		...
		$("#tbodyinventoribarang").on('click', 'tr td a.detailinvenbarang', function (e) {
			var id = $(this).closest('tr').find('td .barang_detail_inout').val();
			 ...
			 $.ajax({
		    	type: "POST",
		    	url: "<?php echo base_url()?>icu/homeicu/get_detail_inventori/" + id,
		    	success: function (data) {
		    		console.log(data);
		...
		$('#permintaanbarangunit').submit(function (e) {
		    ...
		    $.ajax({
				type: "POST",
				data: item,
				url: '<?php echo base_url()?>icu/homeicu/submit_permintaan_barangunit',
				success: function (data) {
					console.log(data);
					if (data['error'] == 'n'){
	...
	function submit_filter (filter) {
		$.ajax({
			type: "POST",
			data: filter,
			url: "<?php echo base_url()?>icu/homeicu/submit_filter_farmasi",
			success:function (data) {
				console.log(data);
