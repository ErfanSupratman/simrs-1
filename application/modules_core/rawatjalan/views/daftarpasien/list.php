...
<div class="bar">
	<li style="list-style: none">
		...
		<i class="fa fa-angle-right"></i>
		<a href="<?php echo base_url() ?>rawatjalan/daftarpasien">Nama Pasien</a>
	</li>
</div>
            ...
            <div class="informasi" id="info1">
	            <form class="form-horizontal" role="form">
	           		<div class="form-group">
						...
						<div class="col-md-1">
							<input type="text" class="form-control" id="jnsIdentitas" name="jenis_identitas" value="<?php echo $pasien['jenis_id']; ?>" disabled />
						</div>					
						<div class="col-md-3">
							<input type="text" class="form-control" id="NomorID" name="nomor_identitas" value="<?php echo $pasien['no_id']; ?>" disabled />
						</div>
					</div>	
					<div class="form-group">
						<label class="control-label col-md-3">No RM</label>
						<div class="col-md-4">
							<input type="text" class="form-control" id="rm_id" name="rm_id" value="<?php echo $pasien['rm_id']; ?>" disabled />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Nama Lengkap </label>
						<div class="col-md-4">
							<input type="text" class="form-control" id="NamaLengkap" name="NamaLengkap" value="<?php echo $pasien['nama']; ?>" disabled />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Alias </label>
						<div class="col-md-1">
							<input type="text" class="form-control" id="alias" name="alias" value="<?php echo $pasien['alias']; ?>" disabled />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Jenis Kelamin</label>
						<div class="col-md-1">
							<input type="text" class="form-control" id="jk" name="jk" value="<?php echo $pasien['jenis_kelamin']; ?>" disabled />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Golongan Darah </label>
						<div class="col-md-1">
							<input type="text" class="form-control" id="goldarah" name="goldarah" value="<?php echo $pasien['gol_darah']; ?>" disabled />												
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Agama </label>
						<div class="col-md-2">
							<input type="text" class="form-control" id="agama" name="agama" value="<?php echo $pasien['agama']; ?>" disabled />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Tempat, tanggal lahir </label>
						<div class="col-md-2">
							<input type="text" class="form-control" id="newTempatLahir" name="tempat_lahir" value="<?php echo $pasien['tempat_lahir']; ?>" disabled/>
						</div>
						<div class="col-md-2">
							<input class="form-control input-medium date-picker" maxlength="12" type="text" value="<?php
					...
					<div class="form-group">
						...
						<div class="col-md-2">
							<input type="text" class="form-control" id="status kawin" name="statuskawin" value="<?php echo $pasien['status_perkawinan']; ?>" disabled />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Pendidikan Terakhir</label>
						<div class="col-md-2">
							<input type="text" class="form-control" id="pendidikan" name="pendidikan" value="<?php echo $pasien['pendidikan']; ?>" disabled />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Pekerjaan </label>
						<div class="col-md-2">
							<input type="text" class="form-control" id="Pekerjaan" name="pekerjaan" value="<?php echo $pasien['pekerjaan']; ?>" disabled>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Nomor Telepon</label>
						<div class="col-md-2">
							<input type="text" class="form-control" id="nomorPasien" name="nomor_pasien" value="<?php echo $pasien['no_telp']; ?>" disabled />
						</div>						
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Alamat </label>
						<div class="col-md-5">
							<input type="text" class="form-control" id="Alamat" name="alamat" value="<?php echo $pasien['alamat_skr']; ?>" disabled />
						</div>						
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Alamat KTP</label>
						<div class="col-md-5">
							<input type="text" class="form-control" id="AlamatKTP" name="alamatKTP" value="<?php echo $pasien['alamat_ktp']; ?>" disabled />
						</div>						
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Wilayah </label>									
						<div class="col-md-2">
							<input type="text" class="form-control" id="provinsi" name="provinsi" value="<?php echo $pasien['provinsi_skr']; ?>" disabled />
						</div>												
						<div class="col-md-2">
							<input type="text" class="form-control" id="kabupaten" name="kabupaten" value="<?php echo $pasien['kabupaten_skr']; ?>" disabled />
						</div>												
						<div class="col-md-2">
							<input type="text" class="form-control" id="kecamatan" name="kecamatan" value="<?php echo $pasien['kecamatan_skr']; ?>" disabled />
						</div>
						<div class="col-md-2">
							<input type="text" class="form-control" id="kelurahan" name="kelurahan" value="<?php echo $pasien['kelurahan_skr']; ?>" disabled />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-2">
							<input type="text" class="form-control" id="cara_bayar" name="cara_bayar" value="<?php echo $pasien['pembayaran']; ?>" disabled />
						</div>						
					</div>
				</form>
			</div>
	 		...
	 		<div class="informasi" id="tbhCare">
	 			<form class="form-horizontal" role="form" method="POST" id="submitOver">
	 				<div class="form-group">
						...
						<div class="col-md-2" >
							<div class="input-icon">
								...
								<input type="text" style="cursor:pointer;" class="form-control isian calder" disabled data-date-format="dd/mm/yyyy" data-provide="datepicker" value="<?php echo date("d/m/Y");?>">
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-1">
							<input type="text" style="cursor:pointer;" class="form-control isian" id="kode_utama" placeholder="Kode" data-toggle="modal" data-target="#searchDiagnosa" readonly disabled>
						</div>
						<div class="col-md-3">
							<input type="text" style="cursor:pointer;" class="form-control isian" placeholder="Keterangan" data-toggle="modal" data-target="#searchDiagnosa" readonly disabled>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Diagnosa Sekunder</label>
						<div class="col-md-1">
							<input type="text" style="cursor:pointer;" class="form-control isian" id="kode_sekunder" placeholder="Kode" data-toggle="modal" data-target="#searchDiagnosa" readonly disabled>
						</div>
						<div class="col-md-3">
							<input type="text" style="cursor:pointer;" class="form-control isian" placeholder="Keterangan" data-toggle="modal" data-target="#searchDiagnosa" readonly disabled>
						</div>
							...
							<tbody>
								<?php  
									if (!empty($visit_care)) {
										...
										echo "<tr><td colspan='8' style='text-align:center'>Data Kosong</td></tr>";
									}
								?>
							</tbody>
						</table>
            ...
            <div class="informasi" id="infoResumePulang">
            	<form class="form-horizontal" role="form">
					...
					<div class="form-group" id="wktMati">
						...
						<div class="col-md-2">
							<input type="text" class="form-control" data-provide = "datepicker" name="wktMati" value="<?php echo date("d/m/Y");?>" placeholder="Waktu Kematian">
						</div>					
					</div>
