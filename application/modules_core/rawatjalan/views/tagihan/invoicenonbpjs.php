<div class="title">
	POLIKLINIK UMUM - INVOICE PASIEN NON BPJS
</div>
<div class="bar">
	<li style="list-style: none">
		...
		<i class="fa fa-angle-right"></i>
		<a href="<?php echo base_url() ?>rawatjalan/invoicenonbpjs">Invoice - Nama Pasien</a>
	</li>
</div>
						...
						<table class="table table-striped table-bordered table-hover" id="tbtagihanpenunjang">
							...
							<tbody id="tbody_ttpenunjang">
								<tr>
									...
									<td>asdasd</td>
									<td>asdasd</td>
									<td style="text-align:center">12 Mei 2012 - 12:12</td>
									<td style="text-align:right;">123</td>
									<td style="text-align:right;">123</td>
									<td style="text-align:right;">212</td>
						...
						<div class="modal-body">
							<div class="informasi">
								...
								<div class="form-group">
									...
									<div class="col-md-5">	
										<input type="text" class="typeahead form-control" id="unitperawatan" autocomplete="off" spellcheck="false" name="unitperawatan" placeholder="Unit"  > 
									</div>
								</div>
