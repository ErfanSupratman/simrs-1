...
<!--<script type="text/javascript" src="<?php echo base_url();?>metronic/assets/js/jquery-2.1.3.js"></script>
-->
...
<!--
    <script src="<?php echo base_url();?>metronic/assets/bootstrap3-editable/js/bootstrap.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>metronic/assets/bootstrap3-editable/js/bootstrap.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>metronic/assets/bootstrap3-editable/js/bootstrap-editable.min.js" type="text/javascript"></script>
 
<script src="<?php echo base_url();?>metronic/assets/bootstrap3-editable/js/bootstrap-editable.js" type="text/javascript"></script>
...
<script>	
		   ...
		   //              });
					...
					$('.addNew').on('click', function() {
						...
						$('<tr><td>Baru</td><td>Baru</td><td><a href="#" class="adaanQty editableform editable-click" data-type="text" data-pk="1" data-original-title="Edit Quantity" id="adaanQtyid'+i+'">1</a></td><td>Baru</td><td>Baru</td><td>Baru</td></tr>').appendTo(addDiv);
						i++;
						$(".adaanQty").editable(); 
