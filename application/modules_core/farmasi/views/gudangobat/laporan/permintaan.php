...
$title = 'Laporan_Permintaan_'.$nama_dept.'_'.$sekarang;
...
<body>
	<table>
		<tr>
			<td colspan="18" style="text-align:center;border-bottom:none;"><strong>LAPORAN PERMINTAAN OBAT</strong></td>
		</tr>
		<tr>
			<td colspan="18" style="text-align:center;border-bottom:none;"><strong> <?php echo $dept ?> RS BAHAYANGKARA PALANGKARAYA</strong></td>
		</tr>
	</table>

	<br/>
	<strong>Permintaan obat dari </strong> <?php echo $dept ?>
		...
		<table class="table" id="hasil-evaluasi-dosen">
			<thead>
				<tr class="header">
					...
					<th style="text-align:center;width:300px">Waktu Permintaan</th>
					...
					<th style="text-align:center;width:300px" colspan="2">Jumlah Request</th>
					<th style="text-align:center;width:300px" colspan="2">Jumlah yang Disetujui</th>
				...
				<?php
					...
					foreach ($hasil as $value) {
						echo '<tr class="body">'.
									...
									'<td style="text-align:center;width:300px">'.$value['tanggal_request'].'</td>'.
									'<td style="text-align:center;width:300px" colspan="2">'.$value['peminta'].'</td>'.
									'<td style="text-align:center;width:300px" colspan="2">'.($value['tanggal_respond'] = null ? "-": $value['tanggal_respond']).'</td>'.
									'<td style="text-align:center;width:300px" colspan="2">'.($value['responder'] = null ? "-": $value['responder']).'</td>'.
									...
									'<td style="text-align:center;width:300px" colspan="2">'.$value['jumlah_request'].'</td>'.
									'<td style="text-align:center;width:300px" colspan="2">'.($value['jumlah_approved'] = null ? "0": $value['jumlah_approved']).'</td>'.
