<script type="text/javascript">
	$(document).ready(function () {
		...
		$('#tbodyobatracik').on('click', 'tr td a.addNewKomposisi', function (e) {
			...
			var obat_dept_stok_id = $(this).closest('tr').find('td .obat_dept_id_jual').val();
			...
			var newrow = '<tr>'+
							...
							'<td style="display:none" class="obat_dept_id_select">'+obat_dept_stok_id+'</td>'+
		...
		$('#submitpembayaranobat').submit(function (e) {
			e.preventDefault();
			...
			var item = {};
			item['no_nota'] = $('#id_nota').text();
			item['subtotal'] = $('#subtotalobat').text();
			item['diskon'] = hitung_diskon();
			item['ppn'] = $('#hasilppn').text();
			...
			$.ajax({
				type: "POST",
				data: item,
				url: "<?php echo base_url()?>farmasi/homepenjualanobat/bayar_penjualan_obat",
				success: function (data) {
