		...
		<form class="form-horizontal" id="submit_form" method="POST"> 
			<div class="informasi" id="info1">
					...
					<div class="form-inline">
						...
						<div class="col-md-4">
							<div class="radio-list">
								<label>
									<input type="radio" style="margin-bottom:15px" name="jk" id="newJenisKelamin" value="L" data-title="Pria" required/><span style="margin-left:10px">Pria</span> 
								</label>
								<label style="margin-left: 10px">
									<input type="radio" style="margin-bottom:15px" name="jk" id="newJenisKelamin2" value="P" data-title="Wanita" required/><span style="margin-left:10px">Wanita </span>
								</label>
							</div>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-2">
						<select class="form-control select" 
							id="skrKabupaten" name="kabupaten_skr" required>
				...
				<div class="form-group">
					...
					<div class="col-md-2">
						<select class="form-control select" 
							id="newKabupaten" name="kabupaten">
								<option value="">Pilih Kabupaten</option>
					...
					<div class="col-md-2">
						<select class="form-control select" 
							id="newKecamatan" name="kecamatan">
				            <option value="" selected>Pilih Kecamatan</option>
		    		...
		    		<div class="modal-content">
		    			...
		    			<div class="modal-body">
							...
							<br><br>
								<label class="control-label col-md-3">No. Rekam Medis</label>
								<div class="col-md-7">
									<input type="text" class="form-control" name="modal_rm" placeholder="No Rekam Medis" id="modal_no_rm" disabled>
								</div>
							</div>
							...
							<br><br>
								<label class="control-label col-md-3">Nama Pasien</label>
								<div class="col-md-7">
									<input type="text" class="form-control" name="modal_nama" placeholder="Nama Pasien" id="modal_nama" disabled>
								</div>
							</div>
