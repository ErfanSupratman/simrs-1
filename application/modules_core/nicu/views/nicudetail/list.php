...
<div class="bar">
	<li style="list-style: none">
		...
		<i class="fa fa-angle-right"></i>
		<a href="<?php echo base_url() ?>nicu/nicudetail">Nama Pasien / umur / jk</a>
            	...
            	<form class="form-horizontal" role="form">
	            	<div class="informasi">
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<input type="text" style="cursor:pointer;background-color:white" class="form-control" placeholder="Search Dokter" data-toggle="modal" data-target="#searchDokter" readonly>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<input type="text" style="cursor:pointer;background-color:white" class="form-control" placeholder="Search Asisten" data-toggle="modal" data-target="#searchAsisten" readonly>
							</div>
						</div>
