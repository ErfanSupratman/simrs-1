...
<div class="bar">
	<li style="list-style: none">
		...
		<i class="fa fa-angle-right"></i>
		<a href="<?php echo base_url() ?>nicu/tambahtagihan">Tambah Invoice</a>
	</li>
</div>
     	...
     	<form class="form-horizontal" role="form">
			...
			<div style="margin-left:1030px">
				<span style="background-color:#A7FFAE; padding:0px 10px 0px 10px;">
					...
					<a href="<?php echo base_url() ?>nicu/tagihannonbpjs" class="btn btn-success" id="ivnonbpjs">Tambah Tagihan</a>
  			 		<a href="<?php echo base_url() ?>nicu/tagihanbpjs" class="btn btn-success" id="ivbpjs">Tambah Tagihan</a>
				</span>
			</div>
			<br>
