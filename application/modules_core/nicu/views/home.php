...
<div class="navigation" style="margin-left: 10px" >
 	<ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
	    <li class="active"><a href="#list" data-toggle="tab">List Pasien NICU</a></li>
	    ...
	    <div class="tab-pane active" id="list">
	       <form class="form-horizontal" method="POST" id="search_submit">
		       	<div class="search">
					...
					<div class="col-md-4">		
						<input type="text" id="search_value" class="form-control" placeholder="Masukkan Nama atau Nomor RM Pasien" autofocus>
			        </div>
			        <button type="submit" class="btn btn-danger">Cari</button>&nbsp;
			        <a href="<?php echo base_url() ?>nicu/daftarkelahiran" class="btn btn-warning"> Daftar Kelahiran Baru</a>
				</div>	
			</form>
			<hr class="garis">
									...
									echo ' 
										<tr>
											...
											<td style="text-align:center">
												...
												<a href="nicudetail/daftar/'.$data['ri_id'].'/'.$data['visit_id'].'"><i class="fa fa-plus" data-toggle="tooltip" data-placement="top" title="Pemeriksaan"></i></a>
											</td>										
										</tr>
									';
								}
        ...
        <div class="tab-pane" id="logistik">
            ...
            <div id="ibwpermintaanlogistik">
            	<form class="form-horizontal" role="form">
					...
					<a href="#modalMintaLogBers" data-toggle="modal"><i class="fa fa-plus" style="margin-left :10px; font-size:11pt;">&nbsp;Tambah Obat</i></a>
					<div class="clearfix"></div>
        ...
        <div class="tab-pane" id="tagihan"> 
        	<form class="form-horizontal" method="POST" id="search_submit">
		       	<div class="search">
			        ...
			        <button type="submit" class="btn btn-danger">Cari</button>&nbsp;&nbsp;&nbsp;
			        <a href="<?php echo base_url() ?>nicu/tambahtagihan" data-toggle="modal" class="btn btn-warning"> Tambah Invoice Baru</a>
				</div>	
			</form>
			<hr class="garis">
					...
					<table class="table table-striped table-bordered table-hover table-responsive tableDTUtama">
						...
						<tbody>
							<tr>
								...
								<td>Ansuransi</td>
								<td style="text-align:center">
									<a href="<?php echo base_url() ?>nicu/tagihannonbpjs" ><i class="glyphicon glyphicon-plus" data-toggle="tooltip" data-placement="top" title="Tambah Tagihan"></i></a>
								</td>										
							</tr>
							<tr>
								<td align="center">2</td>
								...
								<td>BPJS</td>
								<td style="text-align:center">
									<a href="<?php echo base_url() ?>nicu/tagihanbpjs" ><i class="glyphicon glyphicon-plus" data-toggle="tooltip" data-placement="top" title="Tambah Tagihan"></i></a>
								</td>										
							</tr>
						</tbody>
					</table>
